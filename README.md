...
<p align="center">Networking<br>DDoS mitigation<br>Working with High Loads (nginx, haproxy)<br>Performance enthusiast<br>Languages: Golang, Python, C/++, NodeJS (html, css)<br>Hobbys: osu!, Beat Saber</p>
